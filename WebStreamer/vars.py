...
class Var(object):
    ...
    API_HASH = str(environ.get("API_HASH", "620f0a2aa2cd1474a4953619b3e3643d"))
    BOT_TOKEN = str(environ.get("BOT_TOKEN", "5859161137:AAHAEe6ll9vJfplkl1SYKGJ0XbBwFinguQs"))
    SLEEP_THRESHOLD = int(environ.get("SLEEP_THRESHOLD", "60"))  # 1 minte
    WORKERS = int(environ.get("WORKERS", "6"))  # 6 workers = 6 commands at once
    BIN_CHANNEL = int(
        environ.get("BIN_CHANNEL", "-1001834779127")
    ...
    if "DYNO" in environ:
        ...
        ON_HEROKU = False
    FQDN = (
        str(environ.get("FQDN", "15.207.143.189"))
    ...
    OWNER_ID = int(environ.get('OWNER_ID', '5291606032'))
